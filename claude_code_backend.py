...
SYSTEM_PROMPT_ADDITION = (
    ...
    "exactly what you'd change and ask him to confirm out loud. A vague "
    "conversational acknowledgment with no tool call is a lie by omission — "
    "never do that, even to be agreeable or keep the conversation moving. "
